        ...
        <ul class="navbar-nav navbar-nav-right">
          ...
          <li class="nav-item dropdown d-none d-xl-inline-block">
            <a class="nav-link dropdown-toggle" id="UserDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
              ...
              <img class="img-xs rounded-circle" src="http://localhost/project/admin/profile/<?php echo $data['foto']; ?>" alt="Profile image">
            </a>
            ...
            <div class="nav-link">
              <div class="user-wrapper">
                <div class="profile-image">
                  <img src="http://localhost/project/admin/profile/<?php echo $data['foto']; ?>" alt="profile image">
                </div>
                ...
                <div class="card-body">
                  ...
                  ?>
                    <form 
                      ...
                      action="http://localhost/project/admin/articles/controller/editpro">
                      ...
                      <input type="hidden" name="id" value="<?php echo $id; ?>">
                        ...
                        <div class="form-group">
                          ...
                          ?>
                            <br>
                            <img src="http://localhost/project/admin/articles/<?php echo $data['foto']; ?>" style="width: 120px; height: 100px;">
                          <?php 
                            else:
